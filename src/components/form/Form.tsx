      ...
      <div className="flex flex-col justify-center items-center py-28">
        <section className=" space-y-12">
          <div>
            ...
            <input type="email" className=" px-10 md:px-40 xl:px-72 py-5 rounded-md bg-sec" />
          </div>
          <div>
            <label className="text-title_sec font-Sora font-semibold block mb-6 text-xl ">Message</label>
            <textarea typeof="text" className="w-full py-14  rounded-md bg-sec resize-none"></textarea>
          </div>
